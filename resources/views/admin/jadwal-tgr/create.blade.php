        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label">PenilaianTanding</label>
                            <select class="form-select @error('PenilaianTanding') is-invalid @enderror" name="PenilaianTanding"
                                id="PenilaianTanding" required>
                                <option selected disabled>Pilih PenilaianTanding</option>
                                <option value="Penyisihan">Penyisihan</option>
                                <option value="Perempat Final">Perempat Final</option>
                                <option value="Semi Final">Semi Final</option>
                                <option value="Final">Final</option>
                            </select>
                            @error('PenilaianTanding')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
