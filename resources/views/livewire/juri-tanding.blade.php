                    ...
                    <tbody>
                        <tr style="border: 2px solid #000">
                            ...
                            @if ($jadwal->PenilaianTanding_tanding==1)
                             <h5 class="fw-bold p-1">
                                {{$PenilaianTanding_1_sudut_merah}}
                             </h5>    
                            @endif
                            </td>
                            <td
                                class="text-center PenilaianTanding-1 {{$jadwal->PenilaianTanding_tanding==1 ? "PenilaianTanding-active" : ""}}"
                        ...
                        <tr style="border: 2px solid #000">
                            ...
                            >
                                ...
                                <h5 class="fw-bold p-1">
                                    {{$PenilaianTanding_2_sudut_merah}}
                                </h5>    
                                @endif
                            </td>
                            <td
                                class="text-center PenilaianTanding-2 {{$jadwal->PenilaianTanding_tanding==2 ? "PenilaianTanding-active" : ""}}"
                                style="border: 2px solid #000; height: 60px"
                            >
                        ...
                        <tr style="border: 2px solid #000">
                            ...
                            @if ($jadwal->PenilaianTanding_tanding==3)
                                <h5 class="fw-bold p-1">
                                    {{$PenilaianTanding_3_sudut_merah}}
                                </h5>    
                            @endif
                            </td>
                            <td
                                class="text-center PenilaianTanding-3 {{$jadwal->PenilaianTanding_tanding==3 ? "PenilaianTanding-active" : ""}}"
                                style="border: 2px solid #000; height: 60px"
                            >
                                <img src={{url('/assets/svg/romawi-2.svg')}}
                                alt="">
